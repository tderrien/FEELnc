...
# 			
# 			print "$tr1 $tr2 $cumul_overlap_size - $cumul_overlap_sizeAS\n";
...
# 	print STDERR "\nOPTIONS : $refh1, $refh2, $strand, $fraction, $wb, $mode, $reciprocal, $verbosity\n";  
...
# 	print STDERR "$refh1, $refh2, $stranded, $uniquexa, $uniquexb, $common, $fraction, $verbosity\n";
